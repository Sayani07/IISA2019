...
So my package gravitas has functions which try to address each of these three broad aspects of granularities. It lets us assess all granularities at our disposal,  compute them, screen the harmonies, check if observations are sufficient for plotting distributions and suggests a recommended plot based on the levels of the cyclic granularities.
...
We can customise the which granularities we want to look at using these options.
