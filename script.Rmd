...
We extend a tsibble object with additional columns containing cyclic granularities. Now, from grammar of graphics, one of the cyclic granularities is considered to act as a aesthetic (x-axis), the measurement is considered on the y-axis and the other cyclic granularity on the facet for the purpose of visualisation.
